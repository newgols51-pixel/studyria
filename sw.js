...
// ── VERSION ───────────────────────────────────────────────────────
const CACHE_VERSION = 'v162'; // v162: P0/P1 honest-data change set — Career Spotlight fully wired (CSS+loader, real jobs, honest error/empty states); Global Search waits for the client and its jobs query fixed (jobs.org column doesn't exist — jobs never matched before); PDF-pipeline failure surfaces as error+Retry instead of fake "no results"; PDP marketing mode + seeded ratings + fake review/sales counts DELETED; marketing page stat band/testimonials truthful. PWA install/push handlers untouched.
